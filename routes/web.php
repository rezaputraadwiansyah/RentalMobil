...
Route::get('/register', 'RegistrasiController@showRegisterForm')->name('register');
Route::post('/proses-register', 'RegistrasiController@prosesRegister')->name('proceed-register');

Route::middleware(['auth'])->group(function () {
    Route::get('logout', 'LoginController@logout')->name('logout');
    Route::middleware('check-role:c2744339-3c63-4f3b-9b9e-efc405a756b3')->group(function () {
    ...
    Route::get('/home', 'HomeCustomerController@home')->name('home.customer');
    Route::get('/car', 'HomeCustomerController@car')->name('car.customer');
    Route::post('/transaction/{id}', 'TransactionController@store')->name('transaction');
});
